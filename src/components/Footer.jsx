...
export default function Footer() {
  ...
  // Función para registrar los clics en las redes del pie de página
  const handleRedesClick = (redName) => {
    ReactGA.event({
        category: "Contacto",
        action: "Clic_Redes_Footer",
        label: redName
    });
  };
      ...
      <div className="flex flex-col gap-6 sm:flex-col md:flex-row md:columns-2 md:gap-16">
        ...
        <div className="flex flex-col items-start gap-2">
            <BtnLink 
              ...
              className="btn-sm"
              onClick={() => handleRedesClick('Google Perfil')}
            >
            ...
            <BtnLink 
              ...
              className="btn-sm"
              onClick={() => handleRedesClick('Llamada Telefonica')}
            >
            ...
            <BtnLink 
              ...
              className="btn-sm"
              onClick={() => handleRedesClick('WhatsApp Footer')}
            >
